...
###################### Value Maximized coalition structure ###################
P = 14.3
Q = 5400
res1 = 7844
res2 = 8180
...
# Timing the calculation of coalition values
t2 = timeit.default_timer()
all_col_val = np.array(discount(coalition_value_intermediate))
t3 = timeit.default_timer()
# print("Time taken for calculating coalition values: ", t3 - t2)
...
for kk in range(len(intersect_agent)):
    ...
    for jj in range(len(cover_col)):
        if intersect_agent[kk] in cover_col[jj]:
            temp_idx.append(jj)
...
# Timing the calculation of final coalition structure values
t4 = timeit.default_timer()
# print("Time taken for calculating final coalition structure values: ", t4 - t3)
